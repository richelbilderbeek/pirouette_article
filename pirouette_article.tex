...
\begin{figure}[H]
  ...
  \caption{
    \new{
      ...
      For the twin tree, the same inference model is used.
      In the 'best' scenarios, for the 'true' tree, 
      the best-fitting candidate models on the 'true' tree
      (JC substitution model, RLN clock model and BD tree prior) 
      was used. 
      In the 'best' scenarios, for the 'twin' tree, 
      the best-fitting candidate models on the 'twin' tree
      (JC substitution model, RLN clock model and Yule tree prior) 
      was used. 
...
\new{
  ...
  indicating that the generative inference model we selected is a good pick.
}
