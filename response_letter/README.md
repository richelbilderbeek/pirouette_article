...
on the simulation algorithm (e.g. Freyman & Höhna 2018), inference in general and computing 
...
whereas Duchêne et al start with an empirical tree. We have described the 
overlap and differences in the manuscript.

HIERO PIPPO BAUDO

 * [ ] Describe overlap and differences with Duchêne et al., 2018 in the manuscript
...
Your suggestion is exactly what we do. After some more careful wording
