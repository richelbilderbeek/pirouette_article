...
\giovanni{tree imbalance is NOT measured with gamma but with beta among other metrics. If we want to mention gamma we should talk about tree balance. I suggest to remove the last sentence here, in order to avoid talking about topology.}
One such statistic is phylogenetic tree balance. In principle,
