\begin{abstract}
  ...
  \textbf{1. }
    ...
    \iffalse
    This will inevitably introduce a bias on the inference, due to the choice of the tree prior. A way to estimate this error is to choose an inference tree prior
    \fi
