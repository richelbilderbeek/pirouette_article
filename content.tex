...
The first step (T1) of the twinning process creates a tree $\tau_{\mathit{T}}$
...
This can be seen for both the "generative" and "candidate" model types (see Table~\ref{tab:options}).
