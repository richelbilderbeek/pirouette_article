...
of relicated runs under multiple settings.
...
we show the usage of \verb;pirouette; by 
showcasing one single run in high detail,
ending in quantifying the impact a tree prior has in Bayesian inference.
...
site model) are JC, HKY, TN and GTR. Only the strict
...
We pick a arbitrary crown age of ten time units.
