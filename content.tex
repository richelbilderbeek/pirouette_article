...
stored in the alignments of both the true and twin alignment.
We achieve this by simply simulating twin alignments up until we
...
\begin{table}[h]
  ...
  \label{tab:functions}
\end{table}
\giovanni{Probably (not 100\% sure) we should make all tables fit within the page limits.}
\richel{Nope, the publisher will do this for us in the end}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{lstlisting}
\begin{figure}[H]
  \includegraphics[width=\textwidth]{example_2/true_tree.png}
...
\end{figure}
\giovanni{
  I find the figure to be too confused. 
  What if we use instead different plots, 
  and in each of them we just show one inference model's results plus its twin counterpart?
}
\richel{Will do}
