...
As a first example, if the generative model is known and standard,
one can specify this as such.
As a second example, if we want to run only the inference
model that fits best to an alignment from a set of candidates,
one can specify this as well (see section 'Candidate models').
