...
\hline
\end{tabular}
\caption{Results of the examples. Errors are shows with the 
  highest posterior density first, and the range of the errors in
  round brackets second. Experiment 4 is split in two rows
...
\giovanni{
  since you refer, for every RQ, to the same values, 
  it could be better to show them as a table
}
