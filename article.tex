...
two models need to be specified. Both models are defined as a combination of 
site model, clock model and a tree prior. The two kind of models are a 
generative and inference model. The generative model is used to simulate 
alignments, the inference model is used to produce a posterior. 
Generative models always use a (constant-rate) birth-death tree prior.
