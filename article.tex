...
We will create a list of experiments as in 
listing~\ref{lst:create_generative_experiment},
...
the same pir\_params XXXXXXXXXXXXXXXXXXXXXXXXXXXx as shown in 
...
with twinning, as alsready shown in 
listing~\ref{lst:create_pir_params_with_twinning}. XXXXXXXXXXXXXXXXXXXXX
