...
The error distribution returned by \verb;pir_run; is a data frame,
that can be plotted directly using \verb;pir_plot;:
...
\begin{figure}[ht]
  ...
  \caption{
    Example 1: the inference error made from a phylogeny 
